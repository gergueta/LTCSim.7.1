...
// $Rev: 17244 $
// File generated on 11/30/2016 11:04:21 AM from Type Library described below.
...
// LCID: 0
// Helpfile: 
// HelpString: ActiveXperts Network Component 4.6 Type Library
// DepndLst: 
...
const
  ...
  IID_IVERDE: TGUID = '{5FE95B15-338D-4DC9-A745-F469FB7B4D7B}';
  CLASS_VERDE: TGUID = '{6225E873-E03D-4376-83E1-5AE5DC49B4AC}';
type
...
// *********************************************************************//
  INwConstants = interface(IDispatch)
    ...
    function Get_nwXEN_CPU_USAGE: Integer; safecall;
    function Get_nwXEN_MEMORY_USAGE: Integer; safecall;
    function Get_nwXEN_MEMORY_AVAILABLE: Integer; safecall;
    function Get_nwXEN_MEMORY_USED: Integer; safecall;
    function Get_nwXEN_NETWORK_RATERX: Integer; safecall;
    function Get_nwXEN_NETWORK_RATETX: Integer; safecall;
    function Get_nwXEN_DISK_USAGE: Integer; safecall;
    function Get_nwXEN_DISK_AVAILABLE: Integer; safecall;
    function Get_nwXEN_DISK_USED: Integer; safecall;
    function Get_nwXEN_POWER_STATE: Integer; safecall;
    function Get_nwXEN_GUESTTOOLS: Integer; safecall;
    function Get_nwXEN_POWERSTATE_HALTED: Integer; safecall;
    function Get_nwXEN_POWERSTATE_PAUSED: Integer; safecall;
    function Get_nwXEN_POWERSTATE_RUNNING: Integer; safecall;
    function Get_nwXEN_POWERSTATE_SUSPENDED: Integer; safecall;
    function Get_nwXEN_POWERSTATE_SHUTTINGDOWN: Integer; safecall;
    function Get_nwXEN_POWERSTATE_CRASHED: Integer; safecall;
    function Get_nwXEN_POWERSTATE_UNKNOWN: Integer; safecall;
    function Get_nwXEN_GUESTTOOLS_UNKNOWN: Integer; safecall;
    function Get_nwXEN_GUESTTOOLS_NOTRUNNING: Integer; safecall;
    function Get_nwXEN_GUESTTOOLS_RUNNING: Integer; safecall;
    ...
    function Get_nwVERDE_CPU_USAGE: Integer; safecall;
    function Get_nwVERDE_MEMORY_USAGE: Integer; safecall;
    function Get_nwVERDE_EFFICIENCY: Integer; safecall;
    function Get_nwVERDE_NETWORK_RATERX: Integer; safecall;
    function Get_nwVERDE_NETWORK_RATETX: Integer; safecall;
    function Get_nwVERDE_DISK_SYSTEM_USAGE: Integer; safecall;
    function Get_nwVERDE_DISK_USER_USAGE: Integer; safecall;
    function Get_nwVERDE_MACHINE_STATE: Integer; safecall;
    function Get_nwVERDE_GUESTTOOLS: Integer; safecall;
    function Get_nwVERDE_SESSIONS_CURRENT: Integer; safecall;
    function Get_nwVERDE_SESSIONS_MAXIMUM: Integer; safecall;
    function Get_nwVERDE_SESSIONS_RESERVED: Integer; safecall;
    function Get_nwVERDE_MACHINESTATE_INVALID: Integer; safecall;
    function Get_nwVERDE_MACHINESTATE_NOTRUNNING: Integer; safecall;
    function Get_nwVERDE_MACHINESTATE_RUNNING: Integer; safecall;
    function Get_nwVERDE_GUESTTOOLS_UNKNOWN: Integer; safecall;
    function Get_nwVERDE_GUESTTOOLS_NOTRUNNING: Integer; safecall;
    function Get_nwVERDE_GUESTTOOLS_RUNNING: Integer; safecall;
    function Get_nwRADIUS_PROTOCOL_PAP: Integer; safecall;
    function Get_nwRADIUS_PROTOCOL_CHAP: Integer; safecall;
    ...
    property nwXEN_CPU_USAGE: Integer read Get_nwXEN_CPU_USAGE;
    property nwXEN_MEMORY_USAGE: Integer read Get_nwXEN_MEMORY_USAGE;
    property nwXEN_MEMORY_AVAILABLE: Integer read Get_nwXEN_MEMORY_AVAILABLE;
    property nwXEN_MEMORY_USED: Integer read Get_nwXEN_MEMORY_USED;
    property nwXEN_NETWORK_RATERX: Integer read Get_nwXEN_NETWORK_RATERX;
    property nwXEN_NETWORK_RATETX: Integer read Get_nwXEN_NETWORK_RATETX;
    property nwXEN_DISK_USAGE: Integer read Get_nwXEN_DISK_USAGE;
    property nwXEN_DISK_AVAILABLE: Integer read Get_nwXEN_DISK_AVAILABLE;
    property nwXEN_DISK_USED: Integer read Get_nwXEN_DISK_USED;
    property nwXEN_POWER_STATE: Integer read Get_nwXEN_POWER_STATE;
    property nwXEN_GUESTTOOLS: Integer read Get_nwXEN_GUESTTOOLS;
    property nwXEN_POWERSTATE_HALTED: Integer read Get_nwXEN_POWERSTATE_HALTED;
    property nwXEN_POWERSTATE_PAUSED: Integer read Get_nwXEN_POWERSTATE_PAUSED;
    property nwXEN_POWERSTATE_RUNNING: Integer read Get_nwXEN_POWERSTATE_RUNNING;
    property nwXEN_POWERSTATE_SUSPENDED: Integer read Get_nwXEN_POWERSTATE_SUSPENDED;
    property nwXEN_POWERSTATE_SHUTTINGDOWN: Integer read Get_nwXEN_POWERSTATE_SHUTTINGDOWN;
    property nwXEN_POWERSTATE_CRASHED: Integer read Get_nwXEN_POWERSTATE_CRASHED;
    property nwXEN_POWERSTATE_UNKNOWN: Integer read Get_nwXEN_POWERSTATE_UNKNOWN;
    property nwXEN_GUESTTOOLS_UNKNOWN: Integer read Get_nwXEN_GUESTTOOLS_UNKNOWN;
    property nwXEN_GUESTTOOLS_NOTRUNNING: Integer read Get_nwXEN_GUESTTOOLS_NOTRUNNING;
    property nwXEN_GUESTTOOLS_RUNNING: Integer read Get_nwXEN_GUESTTOOLS_RUNNING;
    ...
    property nwVERDE_CPU_USAGE: Integer read Get_nwVERDE_CPU_USAGE;
    property nwVERDE_MEMORY_USAGE: Integer read Get_nwVERDE_MEMORY_USAGE;
    property nwVERDE_EFFICIENCY: Integer read Get_nwVERDE_EFFICIENCY;
    property nwVERDE_NETWORK_RATERX: Integer read Get_nwVERDE_NETWORK_RATERX;
    property nwVERDE_NETWORK_RATETX: Integer read Get_nwVERDE_NETWORK_RATETX;
    property nwVERDE_DISK_SYSTEM_USAGE: Integer read Get_nwVERDE_DISK_SYSTEM_USAGE;
    property nwVERDE_DISK_USER_USAGE: Integer read Get_nwVERDE_DISK_USER_USAGE;
    property nwVERDE_MACHINE_STATE: Integer read Get_nwVERDE_MACHINE_STATE;
    property nwVERDE_GUESTTOOLS: Integer read Get_nwVERDE_GUESTTOOLS;
    property nwVERDE_SESSIONS_CURRENT: Integer read Get_nwVERDE_SESSIONS_CURRENT;
    property nwVERDE_SESSIONS_MAXIMUM: Integer read Get_nwVERDE_SESSIONS_MAXIMUM;
    property nwVERDE_SESSIONS_RESERVED: Integer read Get_nwVERDE_SESSIONS_RESERVED;
    property nwVERDE_MACHINESTATE_INVALID: Integer read Get_nwVERDE_MACHINESTATE_INVALID;
    property nwVERDE_MACHINESTATE_NOTRUNNING: Integer read Get_nwVERDE_MACHINESTATE_NOTRUNNING;
    property nwVERDE_MACHINESTATE_RUNNING: Integer read Get_nwVERDE_MACHINESTATE_RUNNING;
    property nwVERDE_GUESTTOOLS_UNKNOWN: Integer read Get_nwVERDE_GUESTTOOLS_UNKNOWN;
    property nwVERDE_GUESTTOOLS_NOTRUNNING: Integer read Get_nwVERDE_GUESTTOOLS_NOTRUNNING;
    property nwVERDE_GUESTTOOLS_RUNNING: Integer read Get_nwVERDE_GUESTTOOLS_RUNNING;
    property nwRADIUS_PROTOCOL_PAP: Integer read Get_nwRADIUS_PROTOCOL_PAP;
    property nwRADIUS_PROTOCOL_CHAP: Integer read Get_nwRADIUS_PROTOCOL_CHAP;
  end;
...
// *********************************************************************//
  INwConstantsDisp = dispinterface
    ...
    property nwXEN_CPU_USAGE: Integer readonly dispid 250;
    property nwXEN_MEMORY_USAGE: Integer readonly dispid 251;
    property nwXEN_MEMORY_AVAILABLE: Integer readonly dispid 252;
    property nwXEN_MEMORY_USED: Integer readonly dispid 253;
    property nwXEN_NETWORK_RATERX: Integer readonly dispid 254;
    property nwXEN_NETWORK_RATETX: Integer readonly dispid 255;
    property nwXEN_DISK_USAGE: Integer readonly dispid 256;
    property nwXEN_DISK_AVAILABLE: Integer readonly dispid 257;
    property nwXEN_DISK_USED: Integer readonly dispid 258;
    property nwXEN_POWER_STATE: Integer readonly dispid 259;
    property nwXEN_GUESTTOOLS: Integer readonly dispid 260;
    property nwXEN_POWERSTATE_HALTED: Integer readonly dispid 261;
    property nwXEN_POWERSTATE_PAUSED: Integer readonly dispid 262;
    property nwXEN_POWERSTATE_RUNNING: Integer readonly dispid 263;
    property nwXEN_POWERSTATE_SUSPENDED: Integer readonly dispid 264;
    property nwXEN_POWERSTATE_SHUTTINGDOWN: Integer readonly dispid 265;
    property nwXEN_POWERSTATE_CRASHED: Integer readonly dispid 266;
    property nwXEN_POWERSTATE_UNKNOWN: Integer readonly dispid 267;
    property nwXEN_GUESTTOOLS_UNKNOWN: Integer readonly dispid 268;
    property nwXEN_GUESTTOOLS_NOTRUNNING: Integer readonly dispid 269;
    property nwXEN_GUESTTOOLS_RUNNING: Integer readonly dispid 270;
    ...
    property nwVERDE_CPU_USAGE: Integer readonly dispid 300;
    property nwVERDE_MEMORY_USAGE: Integer readonly dispid 301;
    property nwVERDE_EFFICIENCY: Integer readonly dispid 302;
    property nwVERDE_NETWORK_RATERX: Integer readonly dispid 306;
    property nwVERDE_NETWORK_RATETX: Integer readonly dispid 307;
    property nwVERDE_DISK_SYSTEM_USAGE: Integer readonly dispid 308;
    property nwVERDE_DISK_USER_USAGE: Integer readonly dispid 309;
    property nwVERDE_MACHINE_STATE: Integer readonly dispid 311;
    property nwVERDE_GUESTTOOLS: Integer readonly dispid 313;
    property nwVERDE_SESSIONS_CURRENT: Integer readonly dispid 314;
    property nwVERDE_SESSIONS_MAXIMUM: Integer readonly dispid 315;
    property nwVERDE_SESSIONS_RESERVED: Integer readonly dispid 316;
    property nwVERDE_MACHINESTATE_INVALID: Integer readonly dispid 318;
    property nwVERDE_MACHINESTATE_NOTRUNNING: Integer readonly dispid 319;
    property nwVERDE_MACHINESTATE_RUNNING: Integer readonly dispid 321;
    property nwVERDE_GUESTTOOLS_UNKNOWN: Integer readonly dispid 325;
    property nwVERDE_GUESTTOOLS_NOTRUNNING: Integer readonly dispid 326;
    property nwVERDE_GUESTTOOLS_RUNNING: Integer readonly dispid 327;
    property nwRADIUS_PROTOCOL_PAP: Integer readonly dispid 350;
    property nwRADIUS_PROTOCOL_CHAP: Integer readonly dispid 351;
  end;
...
// *********************************************************************//
  ISnmpTrap = interface(IDispatch)
    ...
    function Get_SourceIP: WideString; safecall;
    procedure Set_SourceIP(const pVal: WideString); safecall;
    ...
    property SourceIP: WideString read Get_SourceIP write Set_SourceIP;
  end;
...
// *********************************************************************//
  ISnmpTrapDisp = dispinterface
    ...
    property SourceIP: WideString dispid 108;
...
// *********************************************************************//
  ISsh = interface(IDispatch)
    ...
    procedure Set_CommandTimeout(pVal: Integer); safecall;
    function Get_ConnectTimeout: Integer; safecall;
    procedure Set_ConnectTimeout(pVal: Integer); safecall;
    procedure Run; safecall;
    procedure OpenSession; safecall;
    procedure CloseSession; safecall;
    procedure ExecuteCommand; safecall;
    function IsSessionOpened: WordBool; safecall;
...
// *********************************************************************//
  ISshDisp = dispinterface
    ...
    property ProtocolError: WideString readonly dispid 125;
    property CommandTimeout: Integer dispid 130;
    property ConnectTimeout: Integer dispid 131;
    procedure Run; dispid 201;
    procedure OpenSession; dispid 202;
    procedure CloseSession; dispid 203;
    procedure ExecuteCommand; dispid 204;
    function IsSessionOpened: WordBool; dispid 210;
...
// *********************************************************************//
  ISnmpMibBrowser = interface(IDispatch)
    ...
    function ForwardLookup(const bstrMib: WideString): WideString; safecall;
    function ReverseLookup(const bstrOID: WideString): WideString; safecall;
    procedure AddMibFile(const bstrFile: WideString); safecall;
    property Version: WideString read Get_Version;
    property Build: WideString read Get_Build;
    property Module: WideString read Get_Module;
    property LicenseStatus: WideString read Get_LicenseStatus;
...
// *********************************************************************//
  ISnmpMibBrowserDisp = dispinterface
    ...
    function ForwardLookup(const bstrMib: WideString): WideString; dispid 301;
    function ReverseLookup(const bstrOID: WideString): WideString; dispid 302;
    procedure AddMibFile(const bstrFile: WideString); dispid 303;
  end;
...
// *********************************************************************//
  IRadiusDisp = dispinterface
    ...
    property Protocol: Integer dispid 202;
  end;
...
// *********************************************************************//
  IHttpEx = interface(IDispatch)
    ...
    function Get_AllowSSL2: WordBool; safecall;
    procedure Set_AllowSSL2(pVal: WordBool); safecall;
    function Get_AllowSSL3: WordBool; safecall;
    procedure Set_AllowSSL3(pVal: WordBool); safecall;
    function Get_AllowTLS1: WordBool; safecall;
    procedure Set_AllowTLS1(pVal: WordBool); safecall;
    function Get_AllowTLS11: WordBool; safecall;
    procedure Set_AllowTLS11(pVal: WordBool); safecall;
    function Get_AllowTLS12: WordBool; safecall;
    procedure Set_AllowTLS12(pVal: WordBool); safecall;
    ...
    property AllowSSL2: WordBool read Get_AllowSSL2 write Set_AllowSSL2;
    property AllowSSL3: WordBool read Get_AllowSSL3 write Set_AllowSSL3;
    property AllowTLS1: WordBool read Get_AllowTLS1 write Set_AllowTLS1;
    property AllowTLS11: WordBool read Get_AllowTLS11 write Set_AllowTLS11;
    property AllowTLS12: WordBool read Get_AllowTLS12 write Set_AllowTLS12;
  end;
...
// *********************************************************************//
  IHttpExDisp = dispinterface
    ...
    property AllowSSL2: WordBool dispid 120;
    property AllowSSL3: WordBool dispid 121;
    property AllowTLS1: WordBool dispid 122;
    property AllowTLS11: WordBool dispid 123;
    property AllowTLS12: WordBool dispid 124;
...
// *********************************************************************//
  IVMware = interface(IDispatch)
    ...
    function Get_ServerPort: Integer; safecall;
    procedure Set_ServerPort(pVal: Integer); safecall;
    function Get_ServerUseSSL: WordBool; safecall;
    procedure Set_ServerUseSSL(pVal: WordBool); safecall;
    property Version: WideString read Get_Version;
    property Build: WideString read Get_Build;
    property Module: WideString read Get_Module;
    property LicenseStatus: WideString read Get_LicenseStatus;
    ...
    property RequestTimeout: Integer read Get_RequestTimeout write Set_RequestTimeout;
    property ServerPort: Integer read Get_ServerPort write Set_ServerPort;
    property ServerUseSSL: WordBool read Get_ServerUseSSL write Set_ServerUseSSL;
  end;
...
// *********************************************************************//
  IVMwareDisp = dispinterface
    ...
    property ServerPort: Integer dispid 301;
    property ServerUseSSL: WordBool dispid 302;
  end;
...
// Interface: IVERDE
// Flags:     (4544) Dual NonExtensible OleAutomation Dispatchable
// GUID:      {5FE95B15-338D-4DC9-A745-F469FB7B4D7B}
// *********************************************************************//
  IVERDE = interface(IDispatch)
    ['{5FE95B15-338D-4DC9-A745-F469FB7B4D7B}']
    function Get_Version: WideString; safecall;
    function Get_Build: WideString; safecall;
    function Get_Module: WideString; safecall;
    function Get_LicenseStatus: WideString; safecall;
    ...
    procedure Connect; safecall;
    procedure Disconnect; safecall;
    function GetFirstImage: WideString; safecall;
    function GetNextImage: WideString; safecall;
    function GetFirstCounterID: Integer; safecall;
    function GetNextCounterID: Integer; safecall;
    function GetCounterDescription(lCounter: Integer): WideString; safecall;
    function GetCounterUnits(lCounter: Integer): WideString; safecall;
...
// *********************************************************************//
  IVERDEDisp = dispinterface
    ...
    procedure Connect; dispid 210;
    procedure Disconnect; dispid 211;
    function GetFirstImage: WideString; dispid 215;
    function GetNextImage: WideString; dispid 216;
    function GetFirstCounterID: Integer; dispid 218;
    function GetNextCounterID: Integer; dispid 219;
    function GetCounterDescription(lCounter: Integer): WideString; dispid 220;
    function GetCounterUnits(lCounter: Integer): WideString; dispid 221;
...
// *********************************************************************//
// The Class CoVERDE provides a Create and CreateRemote method to          
// create instances of the default interface IVERDE exposed by              
// the CoClass VERDE. The functions are intended to be used by             
// clients wishing to automate the CoClass objects exposed by the         
// server of this typelibrary.                                            
// *********************************************************************//
  CoVERDE = class
    class function Create: IVERDE;
    class function CreateRemote(const MachineName: string): IVERDE;
  end;
...
class function CoVERDE.Create: IVERDE;
begin
  Result := CreateComObject(CLASS_VERDE) as IVERDE;
end;

class function CoVERDE.CreateRemote(const MachineName: string): IVERDE;
begin
  Result := CreateRemoteComObject(MachineName, CLASS_VERDE) as IVERDE;
end;
