/* ascin3.c -- Parse for Graphics in Symbol and Schematic ASCII In */
   ...
   *style = '\0';
   if ( sscanf( linebuf, "%*s %s %d %d %d %d %s",
    ...
    { if ( ver24 )
      ...
      Add_Schematic_Grf( GR_LINE | Parse_Width_Style( buff, style ),
                         xy1, xy2, xy1, xy1 );
    }
 }
   ...
   *style = '\0';
   if ( sscanf( linebuf, "%*s %s %d %d %d %d %s",
    ...
    { if ( ver24 )
      ...
      xy1.x = x1; xy1.y = y1; xy2.x = x2; xy2.y = y2;
      Add_Schematic_Grf( GR_RECT | Parse_Width_Style( buff, style ),
                         xy1, xy2, xy1, xy1 );
    }
 }
   ...
   *style = '\0';
   if ( sscanf( linebuf, "%*s %s %d %d %d %d %s",
    ...
    { if ( ver24 )
      ...
      xy1.x = x1; xy1.y = y1; xy2.x = x2; xy2.y = y2;
      Add_Schematic_Grf( GR_CIRC | Parse_Width_Style( buff, style ),
                         xy1, xy2, xy1, xy1 );
    }
 }
   ...
   *style = '\0';
   if ( sscanf( linebuf, "%*s %s %d %d %d %d %d %d %d %d %s", buff,
    ...
    { if ( ver24 )
      ...
      Add_Schematic_Grf( GR_ARC | Parse_Width_Style( buff, style ),
                         xy1, xy2, xy3, xy4 );
    }
 }
